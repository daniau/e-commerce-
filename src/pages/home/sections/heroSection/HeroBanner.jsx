    ...
    md:text-3xl md:mt-10 rounded-2xl   mr-5 lg:mr-20 py-4 px-5 md:py-8 md:px-10 w-[80%]  h-[230px] md:h-[350px] mt-4 shadow-lg shadow-gray-800/40 ">
      <div className="flex  flex-col items-start justify-between space-y-2  sm:space-y-3 md:space-y-5">
        <div className="flex  items-center">
          <img src="/apple.webp" width={50} height={50} className="w-[35px] h-[35px]" alt="Apple logo" />
...
">Up to 10% off Voucher</p>
      ...
      <img src="/heroImage.webp" fetchPriority="high" loading="eager" className="md:w-[60%] md:h-[250px] h-[135px] w-[60%]  transition-transform duration-1000 ease-in-out hover:scale-105" alt="iPhone 14 banner" />
    </div>
  )
}
